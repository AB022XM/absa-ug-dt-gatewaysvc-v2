...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dsarena.corp.gatewaysvc.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dsarena.corp.gatewaysvc.security.DomainUserDetailsService", "createSpringSecurityUser");
