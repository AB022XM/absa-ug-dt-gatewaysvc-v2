package com.dsarena.corp.gatewaysvc.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.dsarena.corp.gatewaysvc.service.EmailAlreadyUsedException ||
            ex instanceof com.dsarena.corp.gatewaysvc.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.dsarena.corp.gatewaysvc.service.InvalidPasswordException
